...
export class Room extends EventEmitter {
    ...
    private _broadcasters: Map<any, any>;
    private _webRtcServer: any;
    private _mediasoupRouter: any;
    private _audioLevelObserver: any;
    private _activeSpeakerObserver: any;
    private _bot: any;
    ...
    async createBroadcaster({ id, displayName, device = {}, rtpCapabilities }: {
        ...
        rtpCapabilities: any; // Replace with the actual type of rtpCapabilities
    }) {
    ...
    async _createDataConsumer(
        ...
        // Must take the Transport the remote Peer is using for consuming.
        const transport: any = Array.from(dataConsumerPeer.data.transports.values())
            .find((t: any) => t.appData.consuming);
